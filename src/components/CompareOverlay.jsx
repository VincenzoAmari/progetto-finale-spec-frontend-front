  ...
  return (
    <div className="compare-overlay">
      <div className="compare-content">
        ...
        {gamesData.length === 3 ? (
          <>
            <div className="compare-cards compare-cards-triple">
              {gamesData.slice(0, 2).map((game) => (
                <div className="compare-card" key={game.id}>
                  <img
                    className="game-detail-image compare-card-image"
                    src={game.image}
                    alt={game.title}
                    onError={(e) => {
                  ...
                  />
                  <div className="game-detail-info compare-card-info">
                    <h1 className="compare-card-title">{game.title}</h1>
                    <p>
            ...
            <div className="compare-cards compare-cards-triple-bottom">
              <div className="compare-card" key={gamesData[2].id}>
                ...
                />
                <div className="game-detail-info compare-card-info">
                  <h1 className="compare-card-title">{gamesData[2].title}</h1>
                  <p>
          ...
          <div className="compare-cards compare-cards-double">
            {gamesData.map((game) => (
              <div className="compare-card" key={game.id}>
                <img
                  className="game-detail-image compare-card-image"
