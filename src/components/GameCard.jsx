...
const GameCard = React.memo(
  ({
    ...
    if (loading) {
      return (
        <div className="game-card game-card-main" onClick={handleClick}>
          ...
          <div className="game-info">
            <div className="game-info-row">
              <span
                ...
                className={`game-compare-btn${
                  compareSelected ? " active" : ""
                }`}
                title={
                  compareSelected
              ...
              <span
                ...
                className={`game-detail-fav${isFavorite ? " active" : ""}`}
                title={
        ...
        <div className="game-info">
          <div className="game-info-row">
            <span
              ...
              className={`game-compare-btn${compareSelected ? " active" : ""}`}
              title={
                compareSelected
                  ? "Rimuovi dalla comparazione"
                  : "Confronta questo gioco"
